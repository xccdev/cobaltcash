...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("Cobalt Cash Core cobaltcash-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  cobaltcash-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded cobalt cash transaction") + "\n" +
                               "  cobaltcash-tx [options] -create [commands]   " + _("Create hex-encoded cobalt cash transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded cobalt cash transaction
