...
This mechanism has been integrated into Bitcore-Node-CobaltCash which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/cobaltcash/insight-api-cobaltcash#web-socket-api](https://github.com/cobaltcash/insight-api-cobaltcash#web-socket-api)
* API: [https://github.com/cobaltcash/insight-api-cobaltcash#swifttx-transactions](https://github.com/cobaltcash/insight-api-cobaltcash#swifttx-transactions)
...
By default, the Cobalt Cash Core daemon will launch using the following constant:

```
static const int DEFAULT_SWIFTTX_DEPTH = 5;
```

This value can be overridden by passing the following argument to the Cobalt Cash Core daemon:
