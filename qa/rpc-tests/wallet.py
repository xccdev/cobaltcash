...
#   c) node1 mines 32 blocks, so now node 0 has 500000XCC, node 1 has 4250XCC, node2 has none.
#   d) node0 sends 601 XCC to node2, in two transactions (301 XCC, then 300 XCC).
