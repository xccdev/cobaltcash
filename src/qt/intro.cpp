...
bool Intro::pickDataDirectory()
{
    ...
    if (!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", false)) {
        ...
        while (true) {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("Cobalt Cash Core"),
     ...
     * override -datadir in the cobaltcash.conf file in the default data directory
     * (to be consistent with cobaltcashd behavior)
     */
    if (dataDir != getDefaultDataDirectory())
