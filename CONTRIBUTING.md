Contributing to Cobalt Cash Core
==================================

The Cobalt Cash Core project operates an open contributor model where anyone is
...
The following applies to code changes to the Cobalt Cash Core project, and is not to be
confused with overall Cobalt Cash Network Protocol consensus changes.

Whether a pull request is merged into Cobalt Cash Core rests with the project merge
...
Patches that change Cobalt Cash consensus rules are considerably more involved than
...
Where a patch set proposes to change the Cobalt Cash consensus, it must have been
...
The project leader is the release manager for each Cobalt Cash Core release.
