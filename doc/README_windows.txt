...
Intro
-----
Cobalt Cash (XCC) is a sustainable cryptocurrency modeled after 
...
high-powered mining hardware. Cobalt Cash utilizes an energy efficient proof-of-stake algorithm, 
...
Setup
-----
Unpack the files into a directory and run cobaltcash-qt.exe.

Cobalt Cash Core is the original Cobalt Cash client and it builds the backbone of the network.
However, it downloads and stores the entire history of Cobalt Cash transactions;
