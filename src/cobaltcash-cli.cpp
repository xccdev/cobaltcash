...
static bool AppInitRPC(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help") || mapArgs.count("-version")) {
        std::string strUsage = _("Cobalt Cash Core RPC client version") + " " + FormatFullVersion() + "\n";
        if (!mapArgs.count("-version")) {
            strUsage += "\n" + _("Usage:") + "\n" +
                        "  cobaltcash-cli [options] <command> [params]  " + _("Send command to Cobalt Cash Core") + "\n" +
                        "  cobaltcash-cli [options] help                " + _("List commands") + "\n" +
                        "  cobaltcash-cli [options] help <command>      " + _("Get help for a command") + "\n";
