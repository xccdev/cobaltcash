...
// Copyright (c) 2017-2018 The Cobalt Cash developers
                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("Cobalt Cash Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a XCC address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and cobaltcash: URIs)"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About Cobalt Cash Core"), this);
    aboutAction->setStatusTip(tr("Show information about Cobalt Cash Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Cobalt Cash"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your XCC addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified XCC addresses"));
    ...
    openAction->setStatusTip(tr("Open a cobaltcash: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Cobalt Cash Core help message to get a list with possible Cobalt Cash command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("Cobalt Cash Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Cobalt Cash network", "", count));
}
...
{
    QString strTitle = tr("Cobalt Cash Core"); // default title
