...
In order to support loading of multiple wallets in cobaltcash-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is cobaltcash.cpp.
...
Changes to cobaltcash.cpp
----------------------
cobaltcash.cpp is the entry point into cobaltcash-qt, and as such, will require some minor modifications to provide hooks for
